...
<head>
    ...
    <title>FoodMart @yield('title')</title>

    <!-- === CSS from your public/css/ folder === -->
    <link rel="stylesheet" href="{{ asset('css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/style.css') }}">           <!-- main style -->
    <!-- Add any other .css files that were in the original <head> -->
    <!-- Example if template has more: -->
    <!-- <link rel="stylesheet" href="{{ asset('css/owl.carousel.min.css') }}"> -->
    <!-- <link rel="stylesheet" href="{{ asset('css/font-awesome.min.css') }}"> etc. -->

</head>
<body>

    <!-- ================================================= -->
    <!-- Paste the FULL <header>...</header> from original index.html here -->
    <!-- Keep EVERY class, id, data-attribute exactly as in the template -->
    <!-- Later we'll replace static cart/items with @if / dynamic content -->
    <!-- For now: copy-paste as-is -->
<header>
    ...
    <!-- Example fragment (you fill the rest): -->
    ...
    <!-- ================================================= -->
    <!-- Paste the FULL <footer>...</footer> from original index.html here -->
    <footer class="py-5">
      <div class="container-fluid">
        <div class="row">
    ...
    <!-- Again: copy exactly, classes and all -->

    <!-- Scripts - match original order -->
    ...
    <!-- Add others: owl.carousel, main.js, etc. -->
