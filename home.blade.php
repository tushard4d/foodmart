...
@section('content')
    ...
    <div class="container py-5 overflowhidden">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text display-6 text-primary">₹{{ number_format($sub->price, 2) }}</p>
                                <p class="text-muted">per month</p>
                                {{-- <a href="#" class="btn btn-success">Subscribe Now</a> --}}
                                <form action="{{ route('subscription.checkout', $sub->id) }}" method="POST"
                                    class="mt-3">
                                    @csrf
                                    ...
                                    @foreach ($trendingProducts as $product)
                                        ...
                                        <div class="col">
                                            <div class="product-item">
                                                ...
                                                <!-- Wishlist heart -->
                                                <a href="#"
                                                    class="btn-wishlist {{ session('favourites') && isset(session('favourites')[$product->id]) ? 'active' : '' }}"
                                            ...
                                            <div class="product-item">
                                                ...
                                                @if ($product->sale_price && $product->sale_price < $product->price)
                                                    <span class="badge bg-success position-absolute m-3">
                                                        -{{ round(100 * (1 - $product->sale_price / $product->price)) }}%
                                                    </span>
                                                @endif
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        @foreach ($newlyArrived as $product)
                            <div class="col">
                                <div class="product-item">
                                    <!-- Discount badge -->
                                    @if ($product->sale_price && $product->sale_price < $product->price)
